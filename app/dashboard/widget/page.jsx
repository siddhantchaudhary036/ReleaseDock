...
export default function WidgetPage() {
  ...
  if (!currentProjectId) {
    return (
      <div>
        <div className="mb-5">
          <h1 className="text-lg font-semibold" style={{ color: theme.text.primary }}>Widget</h1>
          <p className="text-xs mt-0.5" style={{ color: theme.text.tertiary }}>Configure your changelog widget</p>
        </div>
        <p className="text-sm py-12 text-center" style={{ color: theme.text.tertiary }}>Select a project first.</p>
      </div>
    );
  }
  ...
  if (!project) {
    return (
      <div>
        ...
        <p className="text-sm py-12 text-center" style={{ color: theme.text.tertiary }}>Loading…</p>
      </div>
    );
  }
